...
public class KafkaStreamGroupedKey {
  ...
  private static final String BOOTSTRAP_SERVERS = "127.0.0.1:9092, 127.0.0.1:9094, 127.0.0.1:9095";
  ...
  private static final String PROCESSING_GUARANTEE_CONFIG = "exactly_once_v2";
